...
public class ParserTest {
    ...
    private void test(String jmmResource, boolean mustFail) {
        ...
        try {
            ...
            String[] mainArgs = { testFile.getAbsolutePath(), "-Ierror", "-r=7", "-o"};
    ...
    public void testvar_lit_incomp() {
     ...
     @Test
    public void testvar_undef() {test("fixtures/public/fail/semantic/var_undef.jmm", true);    }
    ...
    @Test
    public void testSameNameLocalGlobal() {
        test("fixtures/public/fail/semantic/extra/same_name_local_global_var.jmm", false);
    }

    @Test
    public void testFuncStatic() {
        test("fixtures/public/fail/semantic/extra/func_is_static.jmm", true);
    }

    @Test
    public void testReturnType() {
        test("fixtures/public/fail/semantic/extra/return_type_incomp.jmm", true);
    }

    @Test
    public void testChainedFunctionCalls() {
        test("fixtures/public/fail/semantic/extra/chained_function_calls.jmm", true);
    }

    @Test
    public void undefMethodForObject() {
        test("fixtures/public/fail/semantic/extra/undef_function_for_object.jmm", true);
    }

    @Test
    public void objCreationWrongType() {
        test("fixtures/public/fail/semantic/extra/objCreation_wrong_type.jmm", true);
    }

    @Test
    public void codeGenExample() {
        test("fixtures/public/fail/semantic/extra/codeGenExample.jmm", false);
    }

    @Test
    public void nonExistentType() {
        test("fixtures/public/fail/semantic/extra/nonExistentType.jmm", true);
    }

    @Test
    public void logicOpNot() {
        test("fixtures/public/fail/semantic/extra/logic_op_not.jmm", true);
    }

    @Test
    public void logicOpAnd() {
        test("fixtures/public/fail/semantic/extra/logic_op_and.jmm", true);
    }

    @Test
    public void lessThan() {
        test("fixtures/public/fail/semantic/extra/less_than_incomp.jmm", true);
    }

    @Test
    public void testArea() {
        test("fixtures/public/fail/semantic/extra/testArea.jmm", false);
    }

    @Test
    public void notBooleanCondition() {
        test("fixtures/public/fail/semantic/extra/notBooleanCondition.jmm", true);
    }

    @Test
    public void thisNotInited() {
        test("fixtures/public/fail/semantic/extra/thisNotInited.jmm", true);
    }

    @Test
    public void notInitedInScope() {
        test("fixtures/public/fail/semantic/extra/notInitedWithinScope.jmm", true);
    }
